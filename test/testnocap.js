...
// not instrumenting capture at all. useful for testing the extension. 
...
console.log ( "Starting toplevel testnocap.js");
await init();
requestAnimationFrame(raf);